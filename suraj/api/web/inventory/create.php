...
$query = "INSERT INTO Lab_Inventory VALUES (null,:v1,:v2,:v3,:v4,:v5)";
$stmt = $db->prepare($query);

if (!$stmt->execute([':v1' => $data->name,':v2' => $data->description,':v3' => $data->stocked,':v4' => $data->rentable,':v5' => $data->ti])) {
