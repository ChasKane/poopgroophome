...
function buildMajorTable(majors) {
	...
	for(var idx in majors) {
		newHTML += "<tr><td style='white-space: nowrap' id='_" + idx + "' ondblclick='editMajor(event);' onfocusout='submitMajor(event)'>" + majors[idx].major_name +"</td><button>delete</button></tr>";
	}
